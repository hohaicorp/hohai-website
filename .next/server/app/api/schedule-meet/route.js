...
<strong>Phone:</strong> +91 94350 14933<br>
    ...
    `})},i=e=>({subject:`New Call Request from ${e.name}`,html:`
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  `});async function a(e,r,t){try{let s={from:process.env.EMAIL_USER||"noreply@hohai.com",to:e,subject:r,html:t},i=await o.sendMail(s);return console.log("Email sent successfully:",i.messageId),{success:!0,messageId:i.messageId}}catch(e){return console.error("Email sending failed:",e),{success:!1,error:e.message}}}async function n(e){try{let r=process.env.ADMIN_EMAIL||process.env.EMAIL_USER||"admin@hohai.com",t=s.adminNotification(e),o=await a(r,t.subject,t.html),i=s.customerConfirmation(e),n=await a(e.email,i.subject,i.html);return{adminEmail:o,customerEmail:n}}catch(e){return console.error("Failed to send contact form emails:",e),{adminEmail:{success:!1,error:e.message},customerEmail:{success:!1,error:e.message}}}}async function l(e){try{let r=process.env.ADMIN_EMAIL||process.env.EMAIL_USER||"admin@hohai.com",t=i(e);return await a(r,t.subject,t.html)}catch(e){return console.error("Failed to send schedule call email:",e),{success:!1,error:e.message}}}}};var r=require("../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),o=r.X(0,[276,972,245,637],()=>t(24144));module.exports=o})();